...
mkdir -p genomes/conger_conger

## Download all files from the NCBI genome directory
cd genomes/conger_conger
wget -r -np -nH --cut-dirs=7 ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCF/963/514/075/